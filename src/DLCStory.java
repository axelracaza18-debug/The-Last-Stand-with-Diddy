...
public class DLCStory {
    ...
    public static void playMnemosyneIntro() {
        Displays.typewriter(
                "[Intercom crackles]\n\n" +
                        ...
                        "Zack's chest tightens.\n" +
                        "The lights ahead flicker green...\n\n" +
                        "A sharp pain surges through his head.\n" +
                        "For a split second—\n" +
                        "a lab.\n" +
                        "blood.\n" +
                        "screaming.\n\n" +
    ...
    public static void playHallwayFightStory() {
        Displays.typewriter(
                "\n⚠️ Zack steps into the hallway, tense and alert.\n" +
                        "Water drips from the ceiling.\n" +
                        "Green emergency lights flicker across the walls.\n\n" +
                        "\"What actually happened in here?\"\n\n" +
                        "He raises his gun and moves forward.\n" +
                        "Something feels wrong.\n\n" +
                        "A silhouette appears at the far end of the hallway.\n\n" +
                        "\"Hey! Who are you?!\"\n\n" +
                        "The figure turns its head.\n" +
                        "Slow.\n" +
                        "Unnatural.\n\n" +
                        "It starts walking.\n" +
                        "Normal.\n\n" +
                        "Five steps in—\n" +
                        "its body jerks.\n" +
                        "The walk turns crippled.\n\n" +
                        "Zack stumbles back.\n" +
                        "\"Oh shit...\"\n\n" +
                        "Another silhouette emerges.\n" +
                        "Then another.\n\n" +
                        "Low growls echo through the hallway.\n" +
                        "Infected scientists crawl from the shadows.\n\n" +
    ...
    public static void playPostCombatScene() {
        Displays.typewriter(
                "\nThe hallway falls silent.\n" +
                        "Bodies of the oily infected lie twisted across the floor.\n" +
                        "Green emergency lights flicker… barely alive.\n\n" +

                        "Zack lowers his weapon.\n" +
                        "His hands are shaking.\n\n" +

                        "Zack:\n" +
                        "\"WHO ARE YOU?!\"\n" +
                        "\"WHY DO THEY LOOK LIKE YOU MADE THEM?!\"\n\n" +

                        "[Radio crackles]\n\n" +

                        "Dr. Havel:\n" +
                        "\"Easy, Zack.\"\n" +
                        "\"You’re alive because we did our job.\"\n\n" +

                        "\"Follow the corridor ahead.\"\n" +
                        "\"You deserve to finally see the laboratory.\"\n\n" +

                        "Zack clenches his fist.\n" +
                        "He steps forward… past the corpses.\n\n" +
    ...
    public static void playHeroEnding() {

        Displays.typewriter(
                "\nZack injects the Silk Emperor and pulls back.\n" +
                        "The creature collapses momentarily.\n\n" +

                        "Zack quickly extracts a glowing sample.\n\n" +

                        "Zack:\n" +
                        "\"Got it!\"\n\n" +

                        "He sprints back through the collapsing lab.\n\n" +

                        "[Radio crackles]\n\n" +

                        "Dr. Havel:\n" +
                        "\"Bring it to me! I can synthesize the vaccine!\"\n\n" +

                        "Zack reaches the lab.\n" +
                        "Hands over the sample.\n\n" +

                        "Dr. Havel begins working rapidly.\n\n" +
                        "\"I need your blood zack.. since you have the immunity within you..\"\n"+
                        "Doctor took zack's blood for the process of completing the vaccine\n"+
                        "\"If i combine from the source of the infection and the source of the immunity, it will create a vaccine\"\n"+

                        "Dr. Havel:\n" +
                        "\"I need time… hold it off!\"\n\n" +

                        "Suddenly—\n\n" +

                        "💥 A massive roar shakes the facility.\n\n" +

                        "Zack turns.\n\n" +

                        "The Silk Emperor rises again.\n" +
                        "Larger.\n" +
                        "More unstable.\n" +
                        "More horrifying.\n\n" +
